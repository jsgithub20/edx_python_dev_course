...
def parse_command_line():
    ...
    ap.add_argument('infile', help = 'name of the file to be encrypted or decrypted')
    ap.add_argument('-o', '--outfile', metavar = 'outfile_path', help = 'output file')
    ap.add_argument('-k', '--key', metavar = 'KEY', type = int, default = 1, help = 'encryption/decryption key (must be positive) (default = 1)')
    ap.add_argument('-d', '--decrypt', action = 'store_true', help = 'decrypt the input file')
    ap.add_argument('-a', '--all', action = 'store_true', help = 'decript using all keys [1, 25], save outputs in different files. (useful in case the key is lost or unknown)')
